...
setlocale(0, "")
////////////////////////////
#define при_запуске int main(int агрументов_число, char *аргументы[])
#define выполнить {
...
#define равно ==
#define класс class
#define открытое public
#define защищённое protected
#define закрытое private
